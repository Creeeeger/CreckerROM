PREPARE_ODIN_EXTRA_FIRMWARE_IMAGES()
{
    ...
    PREPARE_SAMSUNG_PIT "$ODIN_EXTRA_CSC_DIR"
}
...
BUILD_ODIN_BL_PACKAGE()
{
    ...
    VERIFY_SAMSUNG_BOOTLOADER_STAGE2_IMAGES_IN_DIR "$BL_DIR"
...
SIGN_ODIN_AP_DOWNLOAD_IMAGES()
{
    FINALIZE_SAMSUNG_DOWNLOAD_IMAGES_IN_DIR "$ODIN_AP_DIR"
}

VERIFY_ODIN_AP_STAGE2_IMAGES()
{
    VERIFY_SAMSUNG_STAGE2_IMAGES_IN_DIR "$ODIN_AP_DIR"
}
...
BUILD_ODIN_CP_PACKAGE()
{
    ...
    FINALIZE_SAMSUNG_DOWNLOAD_IMAGES_IN_DIR "$ODIN_EXTRA_CP_DIR"
...
BUILD_ODIN_CSC_PACKAGE()
{
    ...
    FINALIZE_SAMSUNG_DOWNLOAD_IMAGES_IN_DIR "$ODIN_EXTRA_CSC_DIR"
