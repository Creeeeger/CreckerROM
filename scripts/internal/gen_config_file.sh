...
{
    local VALUE="boot vendor_boot init_boot"
    local EXTRA

    EXTRA="$(GET_DEFAULT_AVB_FIRMWARE_DESCRIPTOR_PARTITIONS)"
...

{
    ...
    GET_BUILD_VAR "TARGET_AVB_HASH_PARTITIONS" "$(GET_DEFAULT_AVB_HASH_PARTITIONS)"
