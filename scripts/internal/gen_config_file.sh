...

{
    ...
    EMIT_EXTRA_AVB_VARS
    GET_BUILD_VAR "TARGET_ENABLE_SAMSUNG_SIGNING" "false"
    GET_BUILD_VAR "TARGET_SAMSUNG_SIGN_AP_IMAGES" "false"
    GET_BUILD_VAR "TARGET_SAMSUNG_SIGN_SUPER_IMAGES" "false"
    GET_BUILD_VAR "TARGET_SAMSUNG_SIGN_BOOTLOADER" "false"
    GET_BUILD_VAR "TARGET_SAMSUNG_BUILD_ODIN_BL_PACKAGE" "false"
